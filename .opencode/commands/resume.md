---
description: Resume a project in a new LLM session
---
...
Then explore the `src/` directory to understand the current codebase —
read the key files and familiarize yourself with the project structure,
architecture, and implementation patterns already in place.
